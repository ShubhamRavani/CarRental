<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="luxbmwx1.aspx.vb" Inherits="luxbmwx1" %>
                ...
                <br />
					...
					<div class="row">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:carrentalsConnection1 %>" SelectCommand="SELECT * FROM [luxurycar] WHERE [c_name]=@c_name">
                             <SelectParameters>
                                        <asp:Parameter  Name="c_name" DefaultValue="X1" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
