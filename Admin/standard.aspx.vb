...
Partial Class Admin_Default
    ...
    Protected Sub Btnsubmit_Click(sender As Object, e As EventArgs) Handles Btnsubmit.Click
        ...
        Dim str As String
        str = "Insert into standardcar values(@cname,@img1,@img2,@img3,@img4,@img5,@img6,@mileage,@ftype,@ftank,@engine,@bhp,@cylinders,@gears,@transmission,@rearac,@seatcap,@boot,@abs,@driverbag,@sensor,@airbags)"
