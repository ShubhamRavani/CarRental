...
Partial Class Admin_Default
    ...
    Protected Sub Btnsubmit_Click(sender As Object, e As EventArgs) Handles Btnsubmit.Click
        ...
        Dim str As String
        str = "Insert into economycar values(@cname,@img1,@img2,@img3,@img4,@img5,@img6,@mileage,@ftype,@ftank,@engine,@bhp,@cylinders,@gears,@ac,@steering,@seatcap,@boot,@centrallock,@brakeassist,@sensor,@airbags)"
