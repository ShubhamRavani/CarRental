...
Partial Class Admin_Default2
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If (Not (IsPostBack)) Then
            ...
            ddlrearac.Items.Clear()
            ddlabs.Items.Clear()
            ddldriverbag.Items.Clear()
            ...
            If dt.Rows.Count > 0 Then
                ...
                ddltrans.Items.Add(dt.Rows(0)(15))
                ddlrearac.Items.Add(dt.Rows(0)(16))
                txtseatcap.Text = dt.Rows(0)(17)
                txtboot.Text = dt.Rows(0)(18)
                ddlabs.Items.Add(dt.Rows(0)(19))
                ddldriverbag.Items.Add(dt.Rows(0)(20))
    ...
    Protected Sub Btnsubmit_Click(sender As Object, e As EventArgs) Handles Btnsubmit.Click
        ...
        Dim str As String
        str = "Update standardcar set c_name=@cname,img1=@img1,img2=@img2,img3=@img3,img4=@img4,img5=@img5,img6=@img6,mileage=@mileage,fuel_type=@ftype,fuel_tank=@ftank,engine=@engine,bhp=@bhp,cylinders=@cylinders,gears=@gears,transmission=@transmission,rearac=@rearac,seat_capacity=@seatcap,boot_space=@boot,abs=@abs,driver_airbag=@driverbag,parking_sensor=@sensor,airbags=@airbags where s_id=" & Session("s_id")
        ...
        cmd.Parameters.AddWithValue("@transmission", ddltrans.Text)
        cmd.Parameters.AddWithValue("@rearac", ddlrearac.Text)
        cmd.Parameters.AddWithValue("@seatcap", txtseatcap.Text)
        cmd.Parameters.AddWithValue("@boot", txtboot.Text)

        cmd.Parameters.AddWithValue("@abs", ddlabs.Text)
        cmd.Parameters.AddWithValue("@driverbag", ddldriverbag.Text)
