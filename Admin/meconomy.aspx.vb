...
Partial Class Admin_Default
    ...
    Protected Sub Btnsubmit_Click(sender As Object, e As EventArgs) Handles Btnsubmit.Click
        ...
        Dim str As String
        str = "Update economycar set c_name=@cname,img1=@img1,img2=@img2,img3=@img3,img4=@img4,img5=@img5,img6=@img6,mileage=@mileage,fuel_type=@ftype,fuel_tank=@ftank,engine=@engine,bhp=@bhp,cylinders=@cylinders,gears=@gears,ac=@ac,power_steering=@steering,seat_capacity=@seatcap,boot_space=@boot,central_lock=@centrallock,brake_assist=@brakeassist,parking_sensor=@sensor,airbags=@airbags where e_id=" & Session("e_id")
        ...
        cmd.Parameters.AddWithValue("@ac", ddlac.Text)
        cmd.Parameters.AddWithValue("@steering", ddlsteering.Text)
        cmd.Parameters.AddWithValue("@seatcap", txtseatcap.Text)
        cmd.Parameters.AddWithValue("@boot", txtboot.Text)

        cmd.Parameters.AddWithValue("@centrallock", ddlcentrallock.Text)
        cmd.Parameters.AddWithValue("@brakeassist", ddlbrakeassist.Text)
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If (Not (IsPostBack)) Then
            ...
            'query = "select * from economycar where c_name=" & Session("cname")

            query = "select * from economycar"
            ...
            ddlac.Items.Clear()
            ddlsteering.Items.Clear()
            ddlcentrallock.Items.Clear()
            ddlbrakeassist.Items.Clear()
            ...
            If dt.Rows.Count > 0 Then
                ...
                ddlac.Items.Add(dt.Rows(0)(15))
                ddlsteering.Items.Add(dt.Rows(0)(16))
                txtseatcap.Text = dt.Rows(0)(17)
                txtboot.Text = dt.Rows(0)(18)
                ddlcentrallock.Items.Add(dt.Rows(0)(19))
                ddlbrakeassist.Items.Add(dt.Rows(0)(20))
                ddlsensor.Items.Add(dt.Rows(0)(21))
                ddlairbags.Items.Add(dt.Rows(0)(22))
