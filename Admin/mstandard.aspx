<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/asite.master" AutoEventWireup="false" CodeFile="mstandard.aspx.vb" Inherits="Admin_Default2" %>
        ...
        <section>
            <div class="container">
                ...
                <div class="6u">
                    ...
                    <!--Economy-->
                    Car Type :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txttypec" runat="server" placeholder="Car Type" Enabled="False"></asp:TextBox>
                    ...
                    Transmission :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="ddltrans" runat="server">
                        <asp:ListItem>Automatic</asp:ListItem>
                    </asp:DropDownList>
                    <br />

                    Rear AC Vents :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="ddlrearac" runat="server">
                    ...
                    ABS :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="ddlabs" runat="server">
                        <asp:ListItem>No</asp:ListItem>
                        <asp:ListItem>Yes</asp:ListItem>
                    </asp:DropDownList>
                    <br />

                    Driver Airbag :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="ddldriverbag" runat="server">
                        <asp:ListItem>No</asp:ListItem>
                        <asp:ListItem>Yes</asp:ListItem>
                    </asp:DropDownList>
                    <br />
