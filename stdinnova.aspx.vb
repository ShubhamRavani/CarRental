...
Partial Class stdinnova
    ...
    Protected Sub btnreserv_Click(sender As Object, e As EventArgs) Handles btnreserv.Click
        ...
        If dt.Rows.Count > 0 Then
            Session("ucid") = dt.Rows(6)(0).ToString()
            Session("uctype") = dt.Rows(6)(2).ToString()
            Session("ucname") = dt.Rows(6)(3).ToString()
            Session("ucrate") = dt.Rows(6)(4).ToString()
