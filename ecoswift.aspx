<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ecoswift.aspx.vb" Inherits="ecoswift" %>
					...
					<div class="row">
                        ...
                        <div class="3u">
                         ...
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:carrentalsConnection1 %>" SelectCommand="SELECT * FROM [economycar] WHERE [c_name]=@c_name">
                            <SelectParameters>
                                        <asp:Parameter  Name="c_name" DefaultValue="Swift" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
					</div>
