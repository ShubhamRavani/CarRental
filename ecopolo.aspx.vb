...
Partial Class ecopolo
    ...
    Protected Sub btnreserv_Click(sender As Object, e As EventArgs) Handles btnreserv.Click
        ...
        If dt.Rows.Count > 0 Then
            Session("ucid") = dt.Rows(0)(0).ToString()
            Session("uctype") = dt.Rows(0)(2).ToString()
            Session("ucname") = dt.Rows(0)(3).ToString()
            Session("ucrate") = dt.Rows(0)(4).ToString()
