<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="stdcr-v.aspx.vb" Inherits="stdcr_v" %>
                ...
                <br />
					...
					<div class="row">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:carrentalsConnection1 %>" SelectCommand="SELECT * FROM [standardcar] WHERE [c_name]=@c_name">
                            <SelectParameters>
                                        <asp:Parameter  Name="c_name" DefaultValue="CR-V" Type="String" />
                             </SelectParameters>
                        </asp:SqlDataSource>
					</div>
