<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ecopolo.aspx.vb" Inherits="ecopolo" %>
                ...
                <br />
					...
					<div class="row">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:carrentalsConnection1 %>" SelectCommand="SELECT * FROM [economycar] WHERE [c_name]=@c_name">
                            <SelectParameters>
                                        <asp:Parameter  Name="c_name" DefaultValue="Polo" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
					</div>
