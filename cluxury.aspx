<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="cluxury.aspx.vb" Inherits="cluxury" %>
                  ...
                  <div class="container">
					<div class="row">
					 <div class="4u">
						...
						<asp:Image ID="Image1" runat="server" ImageUrl="~/Cars/l1.jpg" Width="230px"></asp:Image>
						<div class="grid_desc">
							<asp:DataList ID="DataList1" runat="server" DataKeyField="i_id" DataSourceID="SqlDataSource1">
							    ...
							    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:carrentalsConnection1 %>" SelectCommand="SELECT * FROM [carinform] WHERE [com_name]=@com_name">
                                    <SelectParameters>
                                        <asp:Parameter  Name="com_name" DefaultValue="Audi" Type="String" />
                                    </SelectParameters>
							    </asp:SqlDataSource>
						</div>
                        <br />
						<div class="Details">
							<asp:LinkButton ID="LinkButton1" runat="server" class="button alt" Font-Italic="True" PostBackUrl="~/luxaudia3.aspx">Details</asp:LinkButton>
						</div>
					 ...
					 <div class="4u">
                      <section class="special box">
						<asp:Image ID="Image2" runat="server" ImageUrl="~/Cars/l2.jpg" Width="230px"></asp:Image>
						<div class="grid_desc">
							<asp:DataList ID="DataList2" runat="server" DataKeyField="i_id" DataSourceID="SqlDataSource2">
							        ...
							        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:carrentalsConnection1 %>" SelectCommand="SELECT * FROM [carinform] WHERE [com_name]=@com_name" >
                                        <SelectParameters>
                                            <asp:Parameter  Name="com_name" DefaultValue="BMW" Type="String" />
                                        </SelectParameters>
							    </asp:SqlDataSource>
						</div>
                        <br />
						<div class="Details">
							<asp:LinkButton ID="LinkButton2" runat="server" class="button alt" PostBackUrl="~/luxbmwx1.aspx" Font-Italic="True">Details</asp:LinkButton>
						</div>
                    ...
                    <div class="4u">
                      <section class="special box">
				        <asp:Image ID="Image3" runat="server" ImageUrl="~/Cars/l3.jpg" Width="230px"></asp:Image>
						<div class="grid_desc">
							<asp:DataList ID="DataList3" runat="server" DataKeyField="i_id" DataSourceID="SqlDataSource3">
							    ...
							    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:carrentalsConnection1 %>" SelectCommand="SELECT * FROM [carinform] WHERE [com_name]=@com_name">
                                    <SelectParameters>
                                        <asp:Parameter  Name="com_name" DefaultValue="Land Rover" Type="String" />
                                    </SelectParameters>
							    </asp:SqlDataSource>
						</div>
                        <br />
						<div class="Details">
							<asp:LinkButton ID="LinkButton3" runat="server" class="button alt" PostBackUrl="~/luxrr.aspx" Font-Italic="True">Details</asp:LinkButton>
						</div>
