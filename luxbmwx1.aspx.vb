...
Partial Class luxbmwx1
    ...
    Protected Sub btnreserv_Click(sender As Object, e As EventArgs) Handles btnreserv.Click
        ...
        If dt.Rows.Count > 0 Then
            Session("ucid") = dt.Rows(3)(0).ToString()
            Session("uctype") = dt.Rows(3)(2).ToString()
            Session("ucname") = dt.Rows(3)(3).ToString()
            Session("ucrate") = dt.Rows(3)(4).ToString()
